...
*	- PsnInfoController.java
* </pre>
*
* @ClassName	: PsnInfoController 
* @Description	: 인사 서비스 조건 정보 
* @author 		: TRIPHOS-MOJO
* @date 		: 2018. 6. 11.
* @Version 		: 1.0 
...
*/
@RestController
@RequestMapping(value="/v1/apicv/psn_info", method=RequestMethod.GET)
@Api(tags={"CV"}, description="")
public class PsnInfoController {
	private static final Logger logger = LoggerFactory.getLogger(PsnInfoController.class);
	...
	*/
	@ApiOperation(value="인사 서비스 조건 정보-CV0010", notes="인사 서비스 조건 정보 요청")
	@ApiResponses(value={
	...
	public ResponseEntity<Map<String, Object>> psnInfo(@ApiParam(value="요청JSON", required=true) @RequestHeader(value="access_token") String accessToken
