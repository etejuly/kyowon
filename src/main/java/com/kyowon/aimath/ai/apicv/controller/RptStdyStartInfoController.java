...
*	- RptStdyStartInfoController.java
* </pre>
*
* @ClassName	: RptStdyStartInfoController 
* @Description	: 반복학습 시작 안내 
* @author 		: TRIPHOS-MOJO
* @date 		: 2018. 6. 11.
* @Version 		: 1.0 
...
*/
@RestController
@RequestMapping(value="/v1/apicv/rpt_stdy_start_info", method=RequestMethod.GET)
@Api(tags={"CV"}, description="")
public class RptStdyStartInfoController {
	private static final Logger logger = LoggerFactory.getLogger(RptStdyStartInfoController.class);
	...
	*/
	@ApiOperation(value="반복학습 시작 안내-CV0310", notes="반복학습 진행여부, 시작안내")
	@ApiResponses(value={
	...
	public ResponseEntity<Map<String, Object>> rptStdyStartInfo(@ApiParam(value="요청JSON", required=true) @RequestHeader(value="access_token") String accessToken
