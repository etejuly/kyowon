...
*	- WeakRptStdyYnController.java
* </pre>
*
* @ClassName	: WeakRptStdyYnController 
* @Description	: 취약 재학습 
* @author 		: TRIPHOS-MOJO
* @date 		: 2018. 6. 11.
* @Version 		: 1.0 
...
*/
@RestController
@RequestMapping(value="/v1/apicv/weak_rpt_stdy_yn", method=RequestMethod.GET)
@Api(tags={"CV"}, description="")
public class WeakRptStdyYnController {
	private static final Logger logger = LoggerFactory.getLogger(WeakRptStdyYnController.class);
	...
	*/
	...
	/** 
	* @Title		: 취약 재학습 
	* @Description	: 취약 재학습 동기 부여 및 학습 연결. APP 에서 대시보드의 비즈니스 로직에 관여하지 않는다면, 대시보드에서 대화모델을 호출해야 합니다.
	...
	*/
	@ApiOperation(value="취약 재학습-CV0210", notes="취약 재학습 동기 부여 및 학습 연결. APP 에서 대시보드의 비즈니스 로직에 관여하지 않는다면, 대시보드에서 대화모델을 호출해야 합니다.")
	@ApiResponses(value={
	...
	public ResponseEntity<Map<String, Object>> weakRptStdyYn(@ApiParam(value="요청JSON", required=true) @RequestHeader(value="access_token") String accessToken
